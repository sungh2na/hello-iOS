...
class TrackManager {
    ...
    func loadTracks() -> [AVPlayerItem] {
        ...
        let urls = Bundle.main.urls(forResourcesWithExtension: "mp3", subdirectory: nil) ?? [] // local에 있는 파일에 접근
    ...
    func track(at index: Int) -> Track? {
        ...
        let track = playerItem.convertToTrack()         // AVPlayerItem to Track
        return track
    }
